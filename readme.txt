...
Библиотека пока что готова для работы только с atmega328p и lgt328p (предпочтительнее из за наличия встроенного ЦАП и бОльших частот). Для обычно avr использовал ядро от Гайвера
